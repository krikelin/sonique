<div class="airplays form">
<?php echo $this->Form->create('Airplay'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Airplay'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Airplay.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Airplay.id'))); ?></li>
