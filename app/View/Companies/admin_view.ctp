...
<h2><?php  echo __('Company'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($company['Company']['postal']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Orgnr'); ?></dt>
		<dd>
			<?php echo h($company['Company']['orgnr']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($company['Station'] as $station): ?>
		<tr>
